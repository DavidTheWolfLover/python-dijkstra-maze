...
class myGUI():
    ...
    def UpdateInfo(self):
        ...
        if self.checkEnd:
            text += "End point: [" + ("%.2f" % (maze.points[1][0]+1)) + (", %.2f" % (nrow - 1 - maze.points[1][1])) + "]\n"
    ...
    def draw_graph(self, redraw = True):
        ...
        for i in range(1, nrow):
            ...
            self.draw_line(0, i, -0.15, i, "black", 1, nrow - i)
        ...
        for i in range(1, ncolumn):
            ...
            self.draw_line(i, nrow, i, nrow + 0.15, "black", 1, i)
